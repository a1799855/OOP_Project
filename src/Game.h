...
class Game {
    public:
        ...
        Faction* getPlayerFactionInst() { return playerFactionInstance; }
        Faction* getEnemyFactionInst() { return enemyFactionInstance; }
        ...
        void spawnProjectile(const Projectile& p);                          // Spawns projectiles
        const vector<Projectile>& getProjectiles() const { return projectiles; }
    ...
    private:
        ...
        Faction* playerFactionInstance;
        Faction* enemyFactionInstance;
